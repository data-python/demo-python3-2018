...
```python
s = 'This ch4-module provides regular expression matching operations similar to those found in Perl'
...
pat = r'\s([a-zA-Z]+)'  
r = re.findall(pat,s)
print(r) #['ch4-module', 'provides', 'regular', 'expression', 'matching', 'operations', 'similar', 'to', 'those', 'found', 'in', 'Perl']
```
...
pat = r'\s?([a-zA-Z]+)'  
r = re.findall(pat,s)
print(r) #['This', 'ch4-module', 'provides', 'regular', 'expression', 'matching', 'operations', 'similar', 'to', 'those', 'found', 'in', 'Perl']
```
...
s = 'This,,,   ch4-module ; \t   provides|| regular ; '
